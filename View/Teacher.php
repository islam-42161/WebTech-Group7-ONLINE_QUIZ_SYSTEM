...
<table>
    <tr><td><h2>Teacher account registration</h2></td></tr>
...
<tr>
    <td>
        <label for="teachergroupname">Your group name:</label>
    </td>
    <td><input type="text" name="teachergroupname" id="teachergroupnameId">
    </td>
</tr>

<tr>
    <td><label for="maxstudent">Maximum Student number:</label></td>
    <td><input type="number" name="maxstudent" id="maxstudentId" min="0">
    <input type="checkbox" name="dynamicgroup" id="dynamicgroupId">
    <label for="dynamicgroup">Dynamic group?</label>
</td>
</tr>

</table>
<button type="reset" name="Reset">Reset</button>
<button type="submit" name="TeacherSubmit">Sign Up</button>
