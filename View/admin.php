...
<table width="100%">
    <tr><td><h2>Admin account registration</h2></td></tr>

    <tr>
        <td><label for="admincred">Admin Credential:</label></td>
        <td><input type="text" name="admincred" id="admincredId"></td>
    </tr>
    <tr>
        <td colspan="4"><hr></td>
    </tr>
...
<button type="submit" name="AdminSubmit">Sign Up</button>
